...
def split_nodes_image(old_nodes):
    ...
    for old_node in old_nodes:
        ...
        if original_text != "":
            new_nodes.append(TextNode(original_text, type_text))
    return new_nodes
...
def text_to_textnodes(text):
    ...
    nodes = split_nodes_delimiter(nodes, "**", type_bold)
    nodes = split_nodes_delimiter(nodes, "*", type_italic)
    nodes = split_nodes_delimiter(nodes, "`", type_code)
